...
_TRANSLATIONS = {
    ...
    "grid_help": {"EN": "Click a cell to select it. Edit its color below.", "JA": "セルをクリックして選択し、下部で色を編集します。"},
    "grid_chip_help": {"EN": "Color chip shows palette color. ▶ marks the selected cell.", "JA": "色チップが実際のパレット色です。▶ が選択中セルです。"},
